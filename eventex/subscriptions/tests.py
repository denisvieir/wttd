...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['denisvieira@me.com', 'denisvieira@me.com']
        self.assertEqual(expect, email.to)

    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Denis Vieira', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('denisvieira@me.com', email.body)
        self.assertIn('11-99241-4041', email.body)
